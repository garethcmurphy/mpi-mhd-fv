...
!p.multi=[0,3,3]
plot, density(0,*), ytitle='density' ;,psym=4
plot, temperature(0,*), ytitle='Pressure' ;,psym=4
plot, velx(0,*), ytitle='Velx' ;,psym=4
plot, vely(0,*), ytitle='Vely' ;,psym=4
plot, velz(0,*), ytitle='Velz' ;,psym=4
plot, energy(0,*), ytitle='Energy' ;,psym=4
plot, Bx(0,*), ytitle='Bx' ;,psym=4
plot, By(0,*), ytitle='By' ;,psym=4
plot, Bz(0,*), ytitle='Bz' ;,psym=4
