...
#define CHECK_DIVB
        ...
        parflux(mesh, fx, fy, xjx, xjy, xjz, yjx, yjy, yjz, emfx, emfy, faceBx, faceBy, SoundSpeedMidPlane, del,
                delta_x, delta_y, myaddress, tstep, Cart_comm);
...
//#define SECOND_ORDER_STEP
  ...
  //    get rid of me !!!!!   parboundary (newmesh, newmesh, faceBxt, faceByt, myNorth, mySouth, myEast, myWest, myid, Cart_comm);
        ...
        parupdate(newmesh, mesh, mesh, fx, fy, SecondOrdCorr, faceBx, faceBy, xjx, xjy, xjz, yjx, yjy, yjz, emfx, emfy,
                  SoundSpeedMidPlane, delta_t, delta_x, delta_y, Cart_comm, 0);
#endif
