/* $Id: tnt_array3d.h,v 1.3 2006-10-30 15:17:55 gmurphy Exp $  */
/*
*
...
template < class T > Array3D < T >::Array3D ():data_ (), v_ (), m_ (0),
    n_ (0)
  {
  }
  ...
  template < class T >
    Array3D < T >::Array3D (int m, int n, int g, T val):data_ (m * n * g,
							       val), v_ (m,
									 n),
    m_ (m), n_ (n), g_ (g)
  {
  ...
  template < class T >
    Array3D < T >::Array3D (int m, int n, int g, T * a):data_ (m * n * g, a),
  ...
  template < class T > inline int Array3D < T >::dim1 () const
  {
    return m_;
  }

  template < class T > inline int Array3D < T >::dim2 () const
  {
    return n_;
  }

  template < class T > inline int Array3D < T >::dim3 () const
  {
    return g_;
  }
  ...
  template < class T > inline Array3D < T >::operator   T *** ()
  {
    return v_;
  }


  template < class T > inline Array3D < T >::operator   const T ***()
  {
    return v_;
  }
...
/* extended interface */
					   ...
					   int j1, int k0, int k1)
  {
    ...
    if (!(0 <= i0 && i0 <= i1 && i1 < m_ &&
	  0 <= j0 && j0 <= j1 && j1 < n_ && 0 <= k0 && k0 <= k1 && k1 < g_))
