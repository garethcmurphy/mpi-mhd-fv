/* $Id: tnt_array1d.h,v 1.3 2006-10-30 15:17:55 gmurphy Exp $  */
/*
*
...
template < class T > Array1D < T >::Array1D ():v_ (), n_ (0), data_ (0)
  ...
  template < class T >
    Array1D < T >::Array1D (int n, const T & val):v_ (n), n_ (n),
    data_ (v_.begin ())
  {
#ifdef TNT_DEBUG
  ...
  template < class T > inline Array1D < T >::operator   T * ()
  {
    return &(v_[0]);
  }


  template < class T > inline Array1D < T >::operator   const T *()
  {
    return &(v_[0]);
  }
  ...
  template < class T > inline int Array1D < T >::dim1 () const
  {
    return n_;
  }

  template < class T > inline int Array1D < T >::dim () const
  {
    return n_;
  }
